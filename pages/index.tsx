    ...
    <>
     <div className={styles["home-grid"]}>
       <section className={styles["main-section"]}>
        <div>
          <h1>Vinny&#39;s Corner</h1>
          <h2>About me</h2>
          <p>Vinicius is a freelance full-stack developer based in Ontario with a passion for building safe and efficient
        ...
        <div>
          <h2>What I &#10084;</h2>
          Literature, Music, Hacking, Reverse Engineering and A&W&#39;s Root Beer &#127866; 
        </div>
        <div>
          <h2>You can find me on:</h2>
          <ul>
            <li>
              <a href="https://github.com/abaporu-C" target="_blank" rel="noreferrer">
                <span>
                  <svg width="5vw" height="5vh" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="48" height="48" fill="white" fillOpacity="0.01"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M24 4C12.9543 4 4 12.9543 4 24C4 35.0457 12.9543 44 24 44C35.0457 44 44 35.0457 44 24C44 12.9543 35.0457 4 24 4ZM0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z" fill="black"/>
            ...
            <li>
              <a href="https://twitter.com/vinny_dev" target="_blank" rel="noreferrer">
                <span>
                  <svg width="5vw" height="5vh" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a href="https://www.instagram.com/abaporu_c/" target="_blank" rel="noreferrer">
                <span>
                  <svg width="6vw" height="6vh" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <g>
